...
class UserMvcApiGetxController extends GetxController {
  final UserServiceGetx _service = UserServiceGetx();
  ...
  Future<bool> addUser(String name, String job, String email) async {
    ...
    try {
      ...
      errorMessage.value = 'Gagal menambah user: $e';
      return false;
    } finally {
      isLoading.value = false;
    }
  ...
  Future<bool> updateUser(int id, String name, String job, String email) async {
    ...
    try {
      ...
      errorMessage.value = 'Gagal update user: $e';
      return false;
    } finally {
      isLoading.value = false;
    }
  ...
  Future<bool> deleteUser(int id) async {
    ...
    try {
      ...
      errorMessage.value = 'Gagal menghapus user: $e';
      return false;
    } finally {
      isLoading.value = false;
    }
