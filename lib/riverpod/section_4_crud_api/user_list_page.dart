...
class UserListPageRiverpod extends ConsumerWidget {
  const UserListPageRiverpod({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Riverpod: Daftar User (CRUD API)')),
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => UserFormPageRiverpod(user: user),
                        ),
                      );
                    },
                  ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const UserFormPageRiverpod(),
            ),
          );
        },
