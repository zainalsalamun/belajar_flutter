...
class UserMvcApiRiverpodFormView extends ConsumerStatefulWidget {
  final User? user;

  const UserMvcApiRiverpodFormView({super.key, this.user});

  @override
  ConsumerState<UserMvcApiRiverpodFormView> createState() =>
      _UserMvcApiRiverpodFormViewState();
}

class _UserMvcApiRiverpodFormViewState
    extends ConsumerState<UserMvcApiRiverpodFormView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          widget.user == null
              ? 'Riverpod MVC API: Tambah'
              : 'Riverpod MVC API: Edit',
        ),
      ),
      body: Padding(
