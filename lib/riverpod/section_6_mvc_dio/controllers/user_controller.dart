...
class UserController extends Notifier<UserState> {
  ...
  UserServiceDioRiverpod get _service => ref.read(userServiceProvider);
  ...
  Future<void> fetchUsers() async {
    ...
    try {
      ...
      state = state.copyWith(errorMessage: 'Gagal memuat data: $e', isLoading: false);
    }
  }
  ...
  Future<bool> addUser(String name, String job, String email) async {
    ...
    try {
      ...
      state = state.copyWith(errorMessage: 'Gagal menambah: $e', isLoading: false);
      return false;
    }
  }
  ...
  Future<bool> updateUser(int id, String name, String job, String email) async {
    ...
    try {
      ...
      state = state.copyWith(errorMessage: 'Gagal membarui: $e', isLoading: false);
      return false;
    }
  }
  ...
  Future<bool> deleteUser(int id) async {
    ...
    try {
      ...
      state = state.copyWith(errorMessage: 'Gagal menghapus: $e', isLoading: false);
      return false;
    }
  }
}
